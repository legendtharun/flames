...
let condition = true;
function Toggle() {
  let darkbutton = document.getElementById("ellipse").classList;
  if (condition) {
    darkbutton.add("animate");
    document.getElementById("darkbut").style.background = "#9f1d99";
    document.getElementById("ellipse").style.background = "#F8D8F6";
    document.getElementById("whole").style.background = "#040104";
    document.body.style.background = "#040104";
    document.getElementById("whole").style.color = "#F8D8F6";
    document.body.style.color = "#f8d8f6";
    document.getElementById("footer").style.background = "#040104";
    document.getElementById("footer").style.color = "#F8D8F6";
    condition = false;
  } else {
    darkbutton.remove("animate");
    document.getElementById("darkbut").style.background = "#F8D8F6";
    document.getElementById("ellipse").style.background = "#9f1d99";
    document.getElementById("whole").style.background = "white";
    document.body.style.background = "white";
    document.getElementById("whole").style.color = "#9f1d99";
    document.body.style.color = "#9f1d99";
    document.getElementById("footer").style.background = "white";
    document.getElementById("footer").style.color = "#9f1d99";
    condition = true;
  }
}
